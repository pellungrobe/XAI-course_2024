    ...
    def fit(self, X, epochs=30000, batch_size=128, sample_interval=100):
        """
         ...
         Arguments: 
            ...
            sample interval: Save a sample of reconstructed image_examples on the weights folder every sample_interval epochs
        """
        ...
        for epoch in range(epochs):
            ...
            # Select a random batch of image_examples
